...
export const findDeviceWithOpenPort = (connectedDevices) => new Promise((resolve, reject) => {
...
export default composeP(findDeviceWithOpenPort, filterConnectedDevices, getConnectedDevices);
